...
add_action( 'plugins_loaded', 'whbm_load_wc_class' );
function whbm_load_wc_class() {
	...
	if ( class_exists( 'WC_Product_Data_Store_CPT' ) && ! class_exists( 'MAGE_Product_Data_Store_CPT' ) ) {
		...
		add_filter( 'woocommerce_data_stores', 'whtm_woocommerce_data_stores' );
		function whtm_woocommerce_data_stores( $stores ) {
