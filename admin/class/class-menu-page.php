...
$page_1_options = array(
	...
	'page_settings' => array(
        ...
        'section_0' => array(
            'title' 	=> 	__('This is Section Title 0','whbm'),
            //'nav_title' 	=> 	__('This is nav Title 00','whbm'),
            'description' 	=> __('This is section details','whbm'),
            'options' 	=> array(

                array(
                    'id'		=> 'option_group',
                    'title'		=> __('Option group','whbm'),
                    'details'	=> __('Description of Option group  field','whbm'),
                    'type'		=> 'option_group',
                    ...
                    'options'=>array(
                        array(
                            ...
                            'title'		    => __('Text Field','whbm'),
                            'details'	    => __('Description of text field','whbm'),
                            'type'		    => 'text',
                            'default'		=> 'Default Text 1',
                            'placeholder'   => __('Text value 1','whbm'),
                        ),

                        array(
                            'id'		    => 'text_multi_field_565',
                            //'field_name'		    => 'text_multi_field',
                            'title'		    => __('Multi Text Field','whbm'),
                            'details'	    => __('Description of multi text field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Option group accordion','whbm'),
                    'details'	=> __('Description of Option group accordion field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Option group tabs','whbm'),
                    'details'	=> __('Description of Option group tabs field','whbm'),
                ...
                array(
                    'id'		=> 'repeatable_field',
                    'title'		=> __('Repeatable Field','whbm'),
                    'details'	=> __('Repeatable Description','whbm'),
                    'collapsible'=> true,
                    'sortable'	=> true,
                    'limit'	=> 3,
                    'remove_text'   => '<i class="fas fa-times"></i>',
		...
		'section_1' => array(
			'title' 	=> 	__('This is Section Title 1','whbm'),
            'nav_title' 	=> 	__('This is nav Title 01','whbm'),
			'description' 	=> __('This is section details','whbm'),
			'options' 	=> array(
...
//                ),
                ...
                array(
                    ...
                    'title'		    => __('Textarea Field','whbm'),
                    'details'	    => __('Description of textarea field','whbm'),
                ...
                array(
                    ...
                    //'field_name'		    => 'text_multi_field',
                    'title'		=> __('Checkbox Multi Field','whbm'),
                    'details'	=> __('Description of checkbox multi field','whbm'),
                    'default'		=> array('option_3','option_2'),
                    'value'		=> array('option_2'),
                    'type'		    => 'checkbox_multi',
                    'args'		=> array(
                        'option_1'	=> __('Option 1','whbm'),
                        'option_2'	=> __('Option 2','whbm'),
                        'option_3'	=> __('Option 3','whbm'),
                        'option_4'	=> __('Option 4','whbm'),
                    ),
                ),
                ...
                array(
                    'id'		=> 'checkbox_field',
                    //'field_name'		    => 'text_multi_field',
                    'title'		=> __('Checkbox  Field','whbm'),
                    'details'	=> __('Description of checkbox field','whbm'),
                    'default'		=> array('option_3','option_2'),
                    'value'		=> 'option_1',
                    'type'		    => 'checkbox',
                    'args'		=> array(
                ...
                array(
                    'id'		=> 'radio_field',
                    //'field_name'		    => 'text_multi_field',
                    'title'		=> __('Radio Field','whbm'),
                    'details'	=> __('Description of radio field','whbm'),
                    'default'		=> 'option_2',
                    'value'		=> 'option_2',
                    'type'		    => 'radio',
                    'args'		=> array(
                ...
                array(
                    'id'		=> 'select_field',
                    //'field_name'		    => 'text_multi_field',
                    'title'		=> __('Select Field','whbm'),
                    'details'	=> __('Description of select field','whbm'),
                    'default'		=> 'option_2',
                    'value'		=> 'option_2',
                ...
                array(
                    ...
                    'args'		=> array(
                        ...
                        'option_3'	=> __('Option 3','whbm'),
                        'option_4'	=> __('Option 4','whbm'),
                        'option_5'	=> __('Option 5','whbm'),
                    ),
                ),
                array(
                    'id'		=> 'range_field',
                    'title'		=> __('Range field','whbm'),
                    'details'	=> __('Description of Range field','whbm'),
                    'default'		=> '75',
                    'value'		=> '70',
                    'type'		    => 'range',
                ...
                array(
                    'id'		    => 'switcher_field',
                    'title'		    => __('Switcher Field','whbm'),
                    'details'	    => __('Description of switcher field','whbm'),
                    'value'		    => '',
                    'default'		=> '1',
                    'type'		=> 'switcher',
                    'args'		=> array(
                ...
                array(
                    'id'		    => 'switcher_field_2',
                    'title'		    => __('Switcher Field 2','whbm'),
                    'details'	    => __('Description of switcher field','whbm'),
                    'value'		    => '',
                    'default'		=> '1',
                    'type'		=> 'switcher',
                ...
                array(
                    ...
                    'title'		=> __('Switch icon Field','whbm'),
                    'details'	=> __('Description of switch icon field','whbm'),
                    'value'		=> 'option_2',
                    'type'		=> 'switch',
                    'args'		=> array(
                        'option_1'	=> __('<i class="fas fa-align-left"></i>','whbm'),
                        'option_2'	=> __('<i class="fas fa-align-center"></i>','whbm'),
                        'option_3'	=> __('<i class="fas fa-align-right"></i>','whbm'),
                    ),
                ),
                array(
                    'id'		=> 'switch_field',
                    'title'		=> __('Switch Field','whbm'),
                    'details'	=> __('Description of switch field','whbm'),
                    'value'		=> 'option_2',
                    'default'	=> 'option_2',
                    'type'		=> 'switch',
                ...
                array(
                    ...
                    'title'		=> __('Switch multi Field','whbm'),
                    'details'	=> __('Description of switch multi field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Switch multi Field 9','whbm'),
                    'details'	=> __('Description of switch multi field','whbm'),
                    'value'		=> array('option_3'),
                    'default'		=> array('option_2','option_4'),
                    'type'		=> 'switch_multi',
                ...
                array(
                    'id'		=> 'switch_img_field',
                    'title'		=> __('Switch image Field','whbm'),
                    'details'	=> __('Description of switch image field','whbm'),
                    'default'	=> 'option_2',
                    'width'     =>'100px',
                    'height'    =>'auto',
                    'type'		=> 'switch_img',
                ...
                array(
                    ...
                    'title'		=> __('Switch image Field 1','whbm'),
                    'details'	=> __('Description of switch image field','whbm'),
                    'default'	=> 'option_2',
                    'width'     =>'100px',
                    'height'    =>'auto',
                ...
                array(
                    ...
                    'title'		    => __('Password','whbm'),
                    'details'	    => __('Description of password','whbm'),
                    'value'		    => '',
                    'password_meter'		    => true,
                    'type'		=> 'password',
                    'default'		=> __('','whbm'),
                    'placeholder'   => __('Password','whbm'),
                ),
                array(
                    'id'		=> 'time_format_field',
                    'title'		=> __('Time format Field','whbm'),
                    'details'	=> __('Description of time format field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Time format Field 1','whbm'),
                    'details'	=> __('Description of time format field','whbm'),
                    'args'		=> array('g:i a' ,'g:i A', 'H:i'),
                    'type'		=> 'time_format',
                    'default'	=> 'H:i',
                ...
                array(
                    ...
                    'title'		=> __('Date format Field','whbm'),
                    'details'	=> __('Description of date format field','whbm'),
                    'value'	=> 'Y-m-d',
                ...
                array(
                    ...
                    'title'		=> __('Date format Field 2','whbm'),
                    'details'	=> __('Description of date format field','whbm'),
                    'value'	=> 'Y-m-d',
                    'args'		=> array('F j, Y' ,'Y-m-d', 'm/d/Y' ,'d/m/Y' ),
                    'default'	=> 'F j, Y',
                ...
                array(
                    'id'		    => 'datepicker_field',
                    'title'		    => __('Date picker field','whbm'),
                    'details'	    => __('Description of date picker field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Color picker field','whbm'),
                    'details'	=> __('Description of colorpicker field','whbm'),
                    'default'	=> '#1e73be',
                    'value'		=> '#ff0000',
                    'type'		=> 'colorpicker',
                ...
                array(
                    ...
                    'title'		=> __('Multi colorpicker Field','whbm'),
                    'details'	=> __('Description of multi colorpicker field','whbm'),
                ...
                array(
                    'id'		=> 'link_color_field',
                    'title'		=> __('Link Color picker field','whbm'),
                    'details'	=> __('Description of Link Color field','whbm'),
                    'args'		=> array('link'	=> '#1B2A41','hover' => '#3F3244','active' => '#60495A','visited' => '#7D8CA3' ),
                    'type'		=> 'link_color',
                ),
                array(
                    'id'		=> 'icon_field',
                    'title'		=> __('Icon Field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Icon multi Field','whbm'),
                    'details'	=> __('Description of multi icon field','whbm'),
...
$page_2_options = array(
    ...
    'page_nav' 	=> __( '<i class="fas fa-cog"></i> Nav Title 2', 'whbm' ),
    'priority' => 10,
    'page_settings' => array(

        'section_20' => array(
            'title' 	=> 	__('This is Section Title 10','whbm'),
            'nav_title' 	=> 	__('This is nav Title 10','whbm'),
            'description' 	=> __('This is section details','whbm'),
            'options' 	=> array(
...
//                ),
        ...
        'section_2' => array(
            'title' 	=> 	__('This is Section Title 12','whbm'),
            'nav_title' 	=> 	__('This is nav Title 12','whbm'),
            'description' 	=> __('This is section details','whbm'),
            'options' 	=> array(

                array(
                    'id'		=> 'sidebars_field',
                    'title'		=> __('Sidebar select Field','whbm'),
                    'details'	=> __('Description of sidebars select field','whbm'),
                    //'multiple'=> true,
                    'type'		=> 'select',
                    'args'		=> 'SIDEBARS_ARRAY',
                ),
                array(
                    ...
                    'title'		=> __('Menu select Field','whbm'),
                    'details'	=> __('Description of menu select field','whbm'),
                    //'multiple'=> true,
                    'type'		=> 'select',
                    'args'		=> 'MENUS_ARRAY',
                ),
                array(
                    'id'		=> 'user_roles_field',
                    'title'		=> __('User roles select Field','whbm'),
                    'details'	=> __('Description of user roles select field','whbm'),
                    'multiple'=> true,
                    'type'		=> 'select',
                    'args'		=> 'USER_ROLES',
                ),
                array(
                    'id'		=> 'page_ids_field',
                    'title'		=> __('Page ids Field','whbm'),
                    'details'	=> __('Description of page ids field','whbm'),
                    //'multiple'=> true,
                    'type'		=> 'select',
                ...
                array(
                    'id'		=> 'post_ids_field',
                    'title'		=> __('Post ids select Field','whbm'),
                    'details'	=> __('Description of post ids field','whbm'),
                    //'multiple'=> true,
                    'type'		=> 'select',
                ...
                array(
                    'id'		=> 'post_type_field',
                    'title'		=> __('Post types Field','whbm'),
                    'details'	=> __('Description of Post types select field','whbm'),
                    'multiple'=> true,
                    'type'		=> 'select',
                ...
                array(
                    ...
                    'title'		=> __('Thumb sizes Field','whbm'),
                    'details'	=> __('Description of thumb size select field','whbm'),
                    'multiple'=> true,
                    'type'		=> 'select',
                ...
                array(
                    ...
                    'title'		=> __('Terms select Field','whbm'),
                    'details'	=> __('Description of terms select field','whbm'),
                    'multiple'=> true,
                    'type'		=> 'select',
                    'args'		=> 'TAX_%category%',
                ),
                array(
                    ...
                    'title'		=> __('Select2 User Field','whbm'),
                    'details'	=> __('Description of select2 user field','whbm'),
                    'default'		=> '1',
                    'multiple'		=> false,
                    'type'		=> 'select',
                    'args'		=> 'USER_IDS_ARRAY',
                ...
                array(
                    'id'		=> 'user_field',
                    'title'		=> __('User Field','whbm'),
                    'details'	=> __('Description of user field','whbm'),
                    'default'	=> array(1,11),
                    'type'		=> 'user',
                    'args'		=> 'USER_IDS_ARRAY',
                )
...
$page_3_options = array(
    ...
    'page_nav' 	=> __( '<i class="far fa-bell"></i> Nav Title 3', 'whbm' ),
    'priority' => 10,
    'page_settings' => array(

        'section_3' => array(
            'title' 	=> 	__('This is Section Title 20','whbm'),
            'nav_title' 	=> 	__('This is nav Title 20','whbm'),
            'description' 	=> __('This is section details','whbm'),
            'options' 	=> array(
                ...
                array(
                    ...
                    'title'		=> __('Color palette Field','whbm'),
                    'details'	=> __('Description of color palette field','whbm'),
                ...
                array(
                    ...
                    'title'		=> __('Color palette multi Field','whbm'),
                    'details'	=> __('Description of color palette multi field','whbm'),
                    'colors'		=> array('#dd3333','#1e73be','#8224e3','#e07000','#1e73be','#8224e3'),
                ...
                array(
                    ...
                    'title'		=> __('Color sets Field','whbm'),
                    'details'	=> __('Description of color sets field','whbm'),
                    'sets'		=> array(
                ...
                array(
                    'id'		=> 'field_image_link',
                    'title'		=> __('Image link Field','whbm'),
                    'details'	=> __('Description of image link field','whbm'),
                ...
                array(
                    'id'		    => 'field_media',
                    'title'		    => __('Media ','whbm'),
                    'details'	    => __('Field media description','whbm'),
                    'placeholder'	=> 'https://i.imgur.com/GD3zKtz.png',
                    'type'		=> 'media',
                ),
                array(
                    'id'		=> 'field_media_multi3',
                    'title'		=> __('Media multi','whbm'),
                    'details'	=> __('Media multi field description.','whbm'),
                    'type'		=> 'media_multi',
                ),
                array(
...
$page_4_options = array(
    ...
    'page_nav' 	=> __( '<i class="fas fa-bomb"></i> Nav Title 4', 'whbm' ),
    'priority' => 10,
    'page_settings' => array(

        'section_4' => array(
            'title' 	=> 	__('This is Section Title 30','whbm'),
            'nav_title' 	=> 	__('This is nav Title 30','whbm'),
            'description' 	=> __('This is section details','whbm'),
            'options' 	=> array(

                array(
                    'id'		    => 'google_map_field',
                    'title'		    => __('Google Map Field','whbm'),
                    'details'	    => __('Description of google map field','whbm'),
                    'placeholder'   => __('Text value','whbm'),
                    'preview'       => true,
                    'type'		    => 'google_map',
                    'value'		=> array(
                ...
                array(
                    'id'		    => 'post_objects',
                    'title'		    => __('Post Objects Field','whbm'),
                    'details'	    => __('Description of Post Objects field','whbm'),
                    'sortable'		=> true,
                    'value'		    => array(),
                    'default'		=> array('post_title','menu_order','post_author'),
                    'type'		    => 'post_objects',
                    'args'		=> array(
                        'thumbnail'	=> __('Post Thumbnail','whbm'),
                        'post_title'	=> __('Post Title','whbm'),
                        'post_content'	=> __('Post Content','whbm'),
                        'post_excerpt'	=> __('Post Excerpt','whbm'),
                        'post_author'	=> __('Post Author','whbm'),
                        'post_date'	    => __('Post Date','whbm'),
                        'comment_count'	=> __('Comment Count','whbm'),
                        'menu_order'	=> __('Menu Order','whbm'),
                    ),
                ),
                ...
                array(
                    'id'		    => 'dimensions_field',
                    'title'		    => __('Dimensions Field','whbm'),
                    'details'	    => __('Description of dimensions field','whbm'),
                    'type'		=> 'dimensions',
                    'value'		=> array(
                    ...
                    'args'		=> array(
                        'width'	=> array('name'=>__('Width','whbm'), 'unit'=>'px'),
                        'height'	=> array('name'=>__('Height','whbm'), 'unit'=>'px'),
                ...
                array(
                    'id'		    => 'margin_field',
                    'title'		    => __('Margin Field','whbm'),
                    'details'	    => __('Description of margin field','whbm'),
                    'type'		=> 'margin',
                    'value'		=> array(
                    ...
                    'args'		=> array(
                        'top'	=> array('name'=>__('Top','whbm'), 'unit'=>'px'),
                        'right'	=> array('name'=>__('Right','whbm'), 'unit'=>'px'),
                        'bottom'	=> array('name'=>__('Bottom','whbm'), 'unit'=>'px'),
                        'left'	=> array('name'=>__('Left','whbm'), 'unit'=>'px'),

                    ),
                ),
                array(
                    'id'		    => 'padding_field',
                    'title'		    => __('Padding Field','whbm'),
                    'details'	    => __('Description of padding field','whbm'),
                    'type'		=> 'padding',
                    'value'		=> array(
                        'top'	    => array('val'=>'54', 'unit'=>'px' ),
                ...
                array(
                    'id'		=> 'wp_editor_field',
                    'title'		=> __('WP editor Field','whbm'),
                    'details'	=> __('Description of wp_editor field, please see detail here https://codex.wordpress.org/Function_Reference/wp_editor','whbm'),
                    'editor_settings'=>array('textarea_name'=>'wp_editor_field', 'editor_height'=>'150px'),
                    'placeholder' => __('wp_editor value','whbm'),
                    'default'		=> 'Editor content',
                    'type'		=> 'wp_editor',
                ),
                array(
                    'id'		=> 'select2_field5',
                    'title'		=> __('Select2 Single Field','whbm'),
                    'details'	=> __('Description of select2 single field','whbm'),
                    'default'		=> 'option_3',
                    'multiple'		=> false,
                    'type'		=> 'select2',
                    'args'		=> array(
                ...
                array(
                    ...
                    'title'		=> __('Select2 multiple Field','whbm'),
                    'details'	=> __('Description of select2 multiple field','whbm'),
                ...
                array(
                    'id'		=> 'faq_field',
                    'title'		=> __('FAQ field','whbm'),
                    'details'	=> __('Description of faq field','whbm'),
                    'type'		=> 'faq',
                    'args'		=> array(
...
$page_5_options = array(
    ...
    'page_nav' 	=> __( '<i class="fas fa-bomb"></i> Tools', 'whbm' ),
    'priority' => 10,
    'page_settings' => array(
...
$args = array(
	'add_in_menu'       => true,
	'menu_type'         => 'main',
    'menu_name'         => __( 'Custom Settings', 'whbm' ),
	'menu_title'        => __( 'Custom Settings', 'whbm' ),
	'page_title'        => __( 'Custom Settings', 'whbm' ),
	'menu_page_title'   => __( 'Custom Settings', 'whbm' ),
