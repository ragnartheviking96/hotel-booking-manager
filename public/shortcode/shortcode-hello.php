                        ...
                        <div class="col-md-2">
                            <div class="whbmt_single_package_right">
                                ...
                                <h3>
									...
									$price_start_from = get_post_meta( $hotel_id, 'min_price_starts', true );
									echo wc_price( $price_start_from, $curr_args );
									?></h3>
								<?php
								?>
                            ...
                            <div class="whbmt_catagory border_top">
                                ...
                                <div class="package_catagory_content">
									...
									foreach ( $hotel_facilities as $facilities_value ) {
										?>
                                        <div class="checkbox"><label><input class="mage_hotel_cat" type="checkbox"
                ...
                <div class="off_right">
                    <div class="package_listing">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="home-tab" data-toggle="tab" href="#tab2" role="tab">Low Price
                                    First</a>
                            </li>
                            <li class="nav-item">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="whbmt_single_package_right">
                                                            ...
                                                            <h3>
																...
																$price_start_from = get_post_meta( $_hotels, 'min_price_starts', true );
																echo wc_price( $price_start_from, $curr_args );
																?></h3>
															<?php
															?>
